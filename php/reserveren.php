...
$email =  $_SESSION['email']; //creating variables
...
if (isset($loggedIn2) ){ //if customer logged in
    ...
    header('Location:customLogin.php'); //if not logged in, go to the location
    exit;
}
...
if (isset($_GET ["action2"]) && $_GET ["action2"] === "logout2") { //logout
    ...
    header("Location:customLogin.php"); //go to the location
    exit;
    }
?>
            ...
            <ul class="media-list">
                <li class="media">
                    <div class="media-left">
                        <img class="media-object" src="../img/Zonnebank2.jpg" alt="zonnebank">
                    </div>
